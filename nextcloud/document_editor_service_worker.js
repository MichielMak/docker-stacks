 ...
 *
 * All non-code elements of the Program, including illustrations,
...
// Stub for Analytics.js — returned directly from the SW so ad-blockers cannot intercept it
const g_analyticsStub = 'if(!window.Common)window.Common={};window.Common.Analytics={initialize:function(){},trackEvent:function(){},trackEvent2:function(){}};';
...
self.addEventListener('fetch', (event) => {
	...
	// Return Analytics.js stub directly from the SW (no network request).
	// This bypasses ad-blockers that match the "Analytics.js" filename.
	if (url.endsWith('/Analytics.js') && matchesCacheablePath(url)) {
		event.respondWith(new Response(g_analyticsStub, {
			status: 200,
